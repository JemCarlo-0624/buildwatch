...
$menuConfig = [
    'admin' => [
        ['icon' => 'fa-tachometer-alt', 'label' => 'Dashboard', 'href' => '/admin/dashboard', 'section' => 'Admin Panel'],
        ['icon' => 'fa-users', 'label' => 'Users', 'href' => '/admin/users', 'section' => 'Admin Panel'],
        ['icon' => 'fa-dollar-sign', 'label' => 'Budget Review', 'href' => '/admin/review-budget', 'section' => 'Admin Panel'],
        ['icon' => 'fa-check-circle', 'label' => 'Approve Budget', 'href' => '/admin/approve-budget', 'section' => 'Admin Panel'],
    ],
    'client' => [
        ['icon' => 'fa-tachometer-alt', 'label' => 'Dashboard', 'href' => '/client/dashboard', 'section' => 'Client Panel'],
        ['icon' => 'fa-dollar-sign', 'label' => 'Budget Review', 'href' => '/client/budget-review', 'section' => 'Client Panel'],
    ],
    'pm' => [
        ['icon' => 'fa-tachometer-alt', 'label' => 'Dashboard', 'href' => '/pm/dashboard', 'section' => 'PM Panel'],
        ['icon' => 'fa-project-diagram', 'label' => 'My Projects', 'href' => '/pm/projects', 'section' => 'PM Panel'],
        ['icon' => 'fa-tasks', 'label' => 'Tasks', 'href' => '/tasks', 'section' => 'PM Panel'],
        ['icon' => 'fa-download', 'label' => 'Reports', 'href' => '/reports/generate', 'section' => 'PM Panel'],
    ],
    'worker' => [
        ['icon' => 'fa-tachometer-alt', 'label' => 'Dashboard', 'href' => '/worker/dashboard', 'section' => 'Worker Panel'],
        ['icon' => 'fa-tasks', 'label' => 'My Tasks', 'href' => '/worker/tasks', 'section' => 'Worker Panel'],
        ['icon' => 'fa-project-diagram', 'label' => 'My Projects', 'href' => '/worker/projects', 'section' => 'Worker Panel'],
    ],
];
...
<body class="sidebar-main-layout">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-footer">
            ...
            <a href="/logout" class="btn btn-outline w-100">
