...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2025 at 03:03 PM
...
(253, 6, 'Building Permits and DepEd Compliance', 'labor', 1300000.00, '2025-10-26 12:43:22');
...
(6, 6, 1, 1300000.00, 'pending_client', 'test', '2025-10-26 12:43:22');
...
(5, 'Commercial Building in Bonuan', 'Commercial Building in Bonuanaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'ongoing', 0, 'medium', 1, 1, NULL, '2025-10-27', '2025-10-28', '2025-10-26 12:44:26', '2025-10-26 13:56:33', 2);
...
(10, 5, 7, '2025-10-26 12:45:31'),
(11, 5, 13, '2025-10-26 12:45:33'),
(13, 5, 2, '2025-10-26 13:50:02');
...
(6, 6, 1200000.00, 1300000.00, 'approved', 'test', 'test', 'approved', '2025-10-26 12:42:27', '2025-10-26 12:44:26', NULL);
...
INSERT INTO `project_proposals` (`id`, `admin_id`, `client_id`, `title`, `description`, `start_date`, `end_date`, `status`, `submitted_at`, `client_decision`, `decision_date`, `budget`) VALUES
(1, 1, 1, 'Commercial Building Renovation - Discaya Office', 'Complete renovation of 3-story commercial building including structural repairs, electrical system upgrade, plumbing modernization, interior finishing, and HVAC installation. The project aims to transform the existing structure into a modern office space with improved energy efficiency and contemporary design.', '2025-11-15', '2026-05-30', 'approved', '2025-10-20 00:30:00', 'approved', '2025-10-26 09:58:45', 4500000.00),
(2, 1, 1, 'Two-Story Residential House Construction', 'Construction of a modern two-story residential house with 4 bedrooms, 3 bathrooms, open-concept living and dining area, modern kitchen, and landscaped garden. The design emphasizes natural lighting, energy efficiency, and sustainable materials. Total floor area: 250 square meters.', '2025-12-01', '2026-09-15', 'approved', '2025-10-22 02:15:00', NULL, NULL, 3200000.00),
(3, 1, 1, 'Industrial Warehouse and Storage Facility', 'Construction of a 1,200 square meter industrial warehouse facility with high-ceiling storage area, loading dock, office space, employee facilities, security systems, and parking area. Designed for logistics and distribution operations with modern fire safety and security features.', '2026-01-10', '2026-08-20', 'rejected', '2025-10-23 06:00:00', 'rejected', '2025-10-26 09:57:28', 5800000.00),
(4, 1, 1, 'Educational Facility - Three-Story School Building', 'Construction of a modern three-story school building with 15 classrooms, science laboratories, computer lab, library, administrative offices, faculty room, and multipurpose hall. The design prioritizes natural ventilation, accessibility compliance, and student safety with wide corridors and emergency exits. Total floor area: 2,800 square meters.', '2026-02-01', '2027-01-30', 'approved', '2025-10-24 01:30:00', 'approved', '2025-10-26 09:57:02', 8500000.00),
(5, 1, 1, 'Modern Restaurant and Cafe Complex', 'Construction of a two-story restaurant and cafe facility featuring main dining area with 80-seat capacity, private dining rooms, commercial kitchen with modern equipment, outdoor patio seating, cafe area, bar section, storage rooms, and staff facilities. Design emphasizes ambiance, ventilation, and efficient kitchen workflow. Total floor area: 450 square meters.', '2025-11-20', '2026-06-15', 'approved', '2025-10-24 05:15:00', 'approved', '2025-10-26 09:52:55', 4200000.00),
(6, NULL, 1, 'Commercial Building in Bonuan', 'Commercial Building in Bonuanaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '2025-10-27', '2025-10-28', 'approved', '2025-10-26 12:42:27', 'approved', '2025-10-26 12:44:26', NULL);
...
(89, 5, 'test', '123123123131', 13, 0, '2025-12-21', '2025-10-26 12:46:00', NULL);
